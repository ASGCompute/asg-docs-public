...
| `inference_embeddings` | ✅ Active | Paid | Text embeddings |
| `sandbox_execute` | ✅ Active | Paid | Python code execution |
| `optify_vram_estimate` | ✅ Active | Paid | GPU memory estimation |
| `serverless_invoke` | 🔧 Beta | Paid | Function invocation |
| `gpu_provision` | 🔜 Q2 2026 | — | GPU provisioning |
